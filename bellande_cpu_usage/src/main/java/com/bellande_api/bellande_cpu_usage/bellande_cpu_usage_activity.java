...
public class bellande_cpu_usage_activity extends AppCompatActivity {
    protected bellande_cpu_usage_service cpuUsageService;
    protected String connectivityPasscode;

    public bellande_cpu_usage_activity(Context context) {
        ...
        bellande_cpu_usage_api cpuUsageApi = new Retrofit.Builder()
                .baseUrl(apiUrl)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(bellande_cpu_usage_api.class);

        cpuUsageService = new bellande_cpu_usage_service(apiUrl, inputEndpoint, outputEndpoint, apiAccessKey, cpuUsageApi);
    }
    ...
    private Map<String, Object> loadConfigFromFile(Context context) {
        try {
            ...
            Log.e("bellande_cpu_usage_activity", "Error reading config file: " + e.getMessage());
        }
        return null;
    }
}
