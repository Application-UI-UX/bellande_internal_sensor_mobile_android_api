...
public class bellande_battery_usage_activity extends AppCompatActivity {
    protected bellande_battery_usage_service batteryUsageService;
    protected String connectivityPasscode;

    public bellande_battery_usage_activity(Context context) {
        ...
        bellande_battery_usage_api batteryUsageApi = new Retrofit.Builder()
                .baseUrl(apiUrl)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(bellande_battery_usage_api.class);

        batteryUsageService = new bellande_battery_usage_service(apiUrl, inputEndpoint, outputEndpoint, apiAccessKey, batteryUsageApi);
    }
    ...
    private Map<String, Object> loadConfigFromFile(Context context) {
        try {
            ...
            Log.e("bellande_battery_usage_activity", "Error reading config file: " + e.getMessage());
        }
        return null;
    }
}
