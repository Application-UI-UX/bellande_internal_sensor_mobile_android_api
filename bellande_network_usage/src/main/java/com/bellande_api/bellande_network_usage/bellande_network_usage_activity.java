...
public class bellande_network_usage_activity extends AppCompatActivity {
    protected bellande_network_usage_service networkUsageService;
    ...
    public bellande_network_usage_activity(Context context) {
        ...
        bellande_network_usage_api networkUsageApi = new Retrofit.Builder()
                .baseUrl(apiUrl)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(bellande_network_usage_api.class);

        networkUsageService = new bellande_network_usage_service(apiUrl, inputEndpoint, outputEndpoint, apiAccessKey, networkUsageApi);
    }
    ...
    private Map<String, Object> loadConfigFromFile(Context context) {
        try {
            ...
            Log.e("bellande_network_usage_base_activity", "Error reading config file: " + e.getMessage());
        }
        return null;
    }
}
