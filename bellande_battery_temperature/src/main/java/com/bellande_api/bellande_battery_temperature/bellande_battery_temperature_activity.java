...
public class bellande_battery_temperature_activity extends AppCompatActivity {
    protected bellande_battery_temperature_service batteryTemperatureService;
    protected String connectivityPasscode;

    public bellande_battery_temperature_activity(Context context) {
        ...
        bellande_battery_temperature_api batteryTemperatureApi = new Retrofit.Builder()
                .baseUrl(apiUrl)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(bellande_battery_temperature_api.class);

        batteryTemperatureService = new bellande_battery_temperature_service(apiUrl, inputEndpoint, outputEndpoint, apiAccessKey, batteryTemperatureApi);
    }
    ...
    private Map<String, Object> loadConfigFromFile(Context context) {
        try {
            ...
            Log.e("bellande_battery_temperature_activity", "Error reading config file: " + e.getMessage());
        }
        return null;
    }
}
