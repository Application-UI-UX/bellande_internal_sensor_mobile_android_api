...
public class bellande_gpu_temperature_activity extends AppCompatActivity {
    protected bellande_gpu_temperature_service gpuTemperatureService;
    protected String connectivityPasscode;

    public bellande_gpu_temperature_activity(Context context) {
        ...
        bellande_gpu_temperature_api gpuUsageApi = new Retrofit.Builder()
                .baseUrl(apiUrl)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(bellande_gpu_temperature_api.class);

        gpuTemperatureService = new bellande_gpu_temperature_service(apiUrl, inputEndpoint, outputEndpoint, apiAccessKey, gpuUsageApi);
    }
    ...
    private Map<String, Object> loadConfigFromFile(Context context) {
        try {
            ...
            Log.e("bellande_gpu_temperature_activity", "Error reading config file: " + e.getMessage());
        }
        return null;
    }
}
